# .\venv\Scripts\python.exe .\api.py --host 127.0.0.1 --port 9777 headless-run --log-level=info --execution-device-id 0 --execution-providers cuda --video-memory-strategy tolerant
